...
function Verification() {
  ...
  return (
    <Container>
      <TableContainer>
        <Table className="mt-1" component={Paper}>
          <TableHead>
            <TableRow>
              ...
              <TableRow key={seller.username}>
                ...
                <TableCell style={{ textAlign: "center" }}>
                  {seller.verified != null ? (
                    ...
                    <>
                      <Button variant="outlined" onClick={() => verifySeller(seller.username, true)}>
                        Verify
                      </Button>
                      <Button variant="outlined" onClick={() => verifySeller(seller.username, false)} className="mx-3">
                        Deny
                      </Button>
                    </>
                  )}
