...
using Mikroservis2.Mapping;
using Mikroservis2.Services;
using System;
...
namespace Mikroservis2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ProjectDbContext>(opt => opt.UseSqlServer(connectionString));
